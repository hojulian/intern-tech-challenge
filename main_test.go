...
func TestLatestVersions(t *testing.T) {
	testCases := []struct {
		...
		{
			versionSlice:	[]string{"2.0.1", "2.0.0"},
			expectedResult: []string{},
			minVersion:		semver.New("2.0.2"),
		},
		{
			versionSlice:   []string{"1.10.1", "1.9.5", "1.8.10", "1.10.0", "1.7.14", "1.8.9", "1.9.5"},
		...
		{
			versionSlice:	[]string{"3.0.1", "2.1.1", "2.0.1", "1.0.1"},
			expectedResult: []string{"3.0.1", "2.1.1", "2.0.1"},
			minVersion:		semver.New("2.0.0"),
		},
	}
